...
// classifyError maps SDK and context errors to a *llms.ProviderError. It uses
// the SDK's typed *anthropic.Error (which carries the real HTTP status and
// response headers) rather than string-parsing the message.
